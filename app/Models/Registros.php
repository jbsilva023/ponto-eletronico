...
class Registros extends Model
{
    ...
    public function registersForMoth()
    {
        ...
        (SELECT TIMEDIFF(TIMEDIFF(r1.entrada_intervalo, r1.entrada),TIMEDIFF(r1.saida_intervalo, r1.saida))
                FROM registros as r1 WHERE r1.id = r.id) as saldo,
       (SELECT TIMEDIFF(TIMEDIFF(r3.entrada_intervalo, r3.entrada),TIMEDIFF(r3.saida_intervalo, r3.saida)) FROM registros as r3
